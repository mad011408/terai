...
async def run_interactive(config: Config, args) -> None:
    ...
    # Welcome message
    ui.show_welcome()
    ui.console.print_info(f"Using model: {model}")
    ui.console.print_info("Type 'help' for commands, 'exit' to quit\n")
    ...
    while True:
        try:
            ...
            if user_input.lower() == "/models":
                ...
                for model_id in model_manager.list_model_ids():
                    marker = " [green](current)[/green]" if model_id == model else ""
                    ui.console.print(f"  - {model_id}{marker}")
